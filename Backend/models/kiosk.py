...
class Kiosk(Base):
    ...
    user_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("user_info.id", ondelete="CASCADE"), nullable=False) # 회원 고유아이디
    ...
    shelves = relationship("Shelve", back_populates="kiosk", cascade="all, delete-orphan")
    orders = relationship("Order", back_populates="kiosk", cascade="all, delete-orphan")
